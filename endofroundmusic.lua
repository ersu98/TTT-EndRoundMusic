...
if ( CLIENT ) then
	...
	MsgN( "TTT Music by ersu98 loaded." )
...
playurl:addParam{ type=ULib.cmds.NumArg, min=0, max=100, default=10, hint="volume", ULib.cmds.optional, ULib.cmds.round }
...
playurlcl:addParam{ type=ULib.cmds.NumArg, min=0, max=100, default=5, hint="volume", ULib.cmds.optional, ULib.cmds.round }
...
playvolume:addParam{ type=ULib.cmds.NumArg, min=0, max=100, default=5, hint="times", ULib.cmds.optional, ULib.cmds.round }
